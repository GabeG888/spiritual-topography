...
function Header() {
  return (
    <div className="container mx-auto h-1/2	p-5 max-w-5xl">
      <h2 className="text-black text-3xl font-bold mt-4">Dictionary</h2>
      ...
      <div className="max-w-7xl">
        <div className="text-black flex mt-5">
          <div className="text-black flex border-2 rounded">
            <input
              className="text-black px-4 py-2 md:w-80"
              type="text"
...
function ResultList() {
  return (
    <div className="container mx-auto h-1/2	p-5 max-w-5xl">
      <div>
        <h3 className="text-black text-5xl font-bold mt-4">
        ...
        <h3 className="text-green-600 text-lg flex space-x-5">
          ...
          <button class="bg-transparent hover:bg-zinc-500 text-black font-bold hover:text-black py-2 px-4 border border-zinc-500 hover:border-transparent rounded-full">
            data scraping
          </button>
          <button class="bg-transparent hover:bg-zinc-500 text-black font-bold hover:text-black py-2 px-4 border border-zinc-500 hover:border-transparent rounded-full">
            javascript
